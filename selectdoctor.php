<?php
    ...
    $result = mysql_query("SELECT * FROM doctor, doctorspecialty WHERE doctor.postal = '"
              . mysql_real_escape_string($_GET['postcode']) 
		...
		else
        {
		    ...
		    while($row = mysql_fetch_array( $result ))
            {
				...
				if ($row['moreinfourl'] != '')
                {
                    ...
                    $doc_time_slot_result = mysql_query("select * from doctortimeslot where doctor_id = '"
                        .$doc_id."' and dayofweek_text = '"
                        .$current_day."' ") or die(mysql_error());
